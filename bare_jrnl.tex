...
\begin{abstract}
%\boldmath
In this project we deployed two different honeypots over Raspberry Pi 3 devices in order to analyze attacks directed to the network of the University of Granada. We present here a brief resume of the results of the experiment.
\\\\
On the one hand, we have results from a Kippo honeypot related to brute force attacks from several IP directions, most of them coming from Asia. In addition we show the results of a malware analysis of samples obtained from Kippo. On the other hand, we will obtain several results related to web attacks with another low/medium interaction honeypot, Glastopf.
\\\\
The purposes of this work is to identify and classify several samples of malware to show to the reader a general method to achieve this goal.
\end{abstract}
...
\lstset{basicstyle=\small\ttfamily, breaklines=true, alsoletter={\%}}
\begin{lstlisting}
...
En esta sección analizaremos las diferentes muestras de malware que hemos obtenido mediante el nodo Kippo. Para tal fin se han empleado tanto herramientas manuales como automáticas: {\tt objdump}, {\tt gdb}, {\tt radare} y la API de VirusTotal, entre otros. Las muestras recogidas son muy similares aunque con ligeras variaciones, como la IP a la que se conectan. Podemos ver las características de las principales muestras en la tabla \ref{tab:car}:

\begin{table}
\centering
\begin{tabular}{cccccccc}
malware & arquitectura & bits & SO & binario & lenguaje & desnudo & enlace \\
\hline
mips  & R3000 & 32 & Linux & ELF & C++ & no & estático \\
pomo  & i386  & 32 & Linux & ELF & C   & si & estático \\
syn26 & i386  & 32 & Linux & ELF & C++ & no & estático \\
udp26 & i386  & 32 & Linux & ELF & C++ & si & estático \\
wrt   & R3000 & 32 & Linux & ELF & C++ & no & estático \\
xudp  & i386  & 32 & Linux & ELF & C   & no & estático \\
z     & i386  & 32 & Linux & ELF & C++ & no & estático \\
\end{tabular}
\caption{Características de las principales muestras. Desnudo indica si la información de depuración ha sido eliminada.}
\label{tab:car}
\end{table}
...
\bibliography{IEEEabrv,bare_jrnl}
